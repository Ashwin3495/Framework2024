...
public class ElementUtil {
	...
	public ElementUtil(WebDriver driver) {
		this.driver = driver;
		// If any time the driver is null we must know safety
		if (driver == null) {
			throw new IllegalArgumentException("WebDriver passed to ElementUtil is null!");
		}
	...
	@Step("Locator used to click the element : {0}")
	...
	@Step("Locating the element with {0}")
	 ...
	 * @return
	 */
	@Step("Text entered in location {0}")
	...
	@Step("Title of the page : {0} and time taken : {1}")
